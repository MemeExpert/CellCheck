	...
	<nav class="navbar navbar-default"style="margin-top:-20px;background:#49B24E;">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="https://www.cise.ufl.edu/~abh/coverage.php">Coverage</a></li>
	...
	<div class="col-md-6" style="text-align:center;">
		...
		<div class="tab-content" style="color:#26272B;text-align:left;background: rgba(255, 255, 255, 0.5);border-radius:8px;height:400px;margin-bottom:20px; padding-left:30px; padding-right:30px;">
			<div id="ATnT" class="tab-pane fade in active">
				...
				<form action="contracts.php" method="get">
					<div class="form-group label-floating">
						<input type="submit"  value="select" class="btn btn-raised btn-default" selection="atnt"style="text-align:center;">
					</div>
				</form>
			...
			<div id="TMobile" class="tab-pane fade">
				...
				<form action="contracts.php" method="get">
					<div class="form-group label-floating">
						<input type="submit"  value="select" class="btn btn-raised btn-default" selection="tmobile">
					</div>
				</form>
			</div>
