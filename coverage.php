	...
	<nav class="navbar navbar-default"style="margin-top:-20px;background:#49B24E;">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="https://www.cise.ufl.edu/~abh/contracts.php">Contracts</a></li>
				<li class="active"><a href="https://www.cise.ufl.edu/~abh/coverage.php">Coverage</a></li>
...
<div class="row">
	...
	<div class="col-md-8" style="text-align:left;background: rgba(255, 255, 255, 0.5);border-radius:8px;margin-left:20px;padding-bottom:20px;" id="contractWrapper">
		...
		<div class="row">
			<div class="col-md-6">
				...
				$sqlstatement2 = "SELECT COUNT(*) AS COUNT
					...
					oci_execute($test);
					oci_fetch($test);
					echo "The number of towers with your provider is: ";
			...
			//ATT
				 ...
				 oci_execute($test);
				 oci_fetch($test);
				 echo "The number of towers with AT&T is: ";
				 echo oci_result($test, 'COUNT');
				 oci_free_statement($test);
				 oci_close($connection);
				 ...
				 $connection = oci_connect($username = 'anrivera', $password = '$MarkusS4301!', $connection_string = '//oracle.cise.ufl.edu/orcl');
		 		 ...
		 		 $sqlstatement2 = "SELECT COUNT(*) AS COUNT
		 			 ...
		 			 oci_execute($test);
		 			 oci_fetch($test);
		 			 echo "The number of towers with Verizon is: ";
		 			 echo oci_result($test, 'COUNT');
		 			 oci_free_statement($test);
					 oci_close($connection);
					 ...
					 $connection = oci_connect($username = 'anrivera', $password = '$MarkusS4301!', $connection_string = '//oracle.cise.ufl.edu/orcl');
			 		 ...
			 		 $sqlstatement2 = "SELECT COUNT(*) AS COUNT
			 			 ...
			 			 oci_execute($test);
			 			 oci_fetch($test);
			 			 echo "The number of towers with Sprint is: ";
			 			 echo oci_result($test, 'COUNT');
			 			 oci_free_statement($test);
						 oci_close($connection);
						...
						$sqlstatement2 = "SELECT COUNT(*) AS COUNT
							...
							oci_execute($test);
							oci_fetch($test);
							echo "The number of towers with T-Mobile is: ";
							echo oci_result($test, 'COUNT');
							oci_free_statement($test);
							oci_close($connection);
		...
		<div>
			<table style="margin-left:10px;">This is where your table goes
			<tr>
				<td>Tower Longitude</td>
				<td>Tower Lattitude</td>
				<td>Tower Height</td>
			</tr>
			<tr>
				<td>5</td>
